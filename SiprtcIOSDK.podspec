...
Pod::Spec.new do |s|
  s.name             = 'SiprtcIOSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SiprtcIOSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SP/SiprtcIOSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SP' => 'shailesh@siprtc.io' }
  s.source           = { :git => 'https://github.com/SP/SiprtcIOSDK.git', :tag => s.version.to_s }
